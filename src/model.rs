...
impl DatasetInfo {
  pub fn new() -> Self {
    Self { points: VecDeque::with_capacity(200), max: 200 }
  }
...
pub struct Context {
  ...
  pub field_states: VecDeque<FieldStateEntry>,
}
...
impl Default for ValueConfig {
  fn default() -> Self {
    Self { mode: ValueMode::Ratio, const_den: 1_000_000_000 }
  }
}
